...
struct SendPackedVirtualTouchEventMessage: Sendable {
  ...
  enum Phase: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case began = 1
    case moved = 2
    case stationary = 3
    case ended = 4
...
let SendPackedVirtualTouchEventMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_sendPackedVirtualTouchEventMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<SendPackedVirtualTouchEventMessage>, ProtocolMessageMessage>(
...
extension SendPackedVirtualTouchEventMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SendPackedVirtualTouchEventMessage.Phase: SwiftProtobuf._ProtoNameProviding {
