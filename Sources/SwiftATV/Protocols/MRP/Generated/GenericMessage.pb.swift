...
struct GenericMessage: Sendable {
...
let GenericMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_genericMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<GenericMessage>, ProtocolMessageMessage>(
