...
struct HandlerReturnStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SendCommandStatusCode: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SendCommandResultType: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SendCommandResultStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SendCommandResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct SendCommandResultMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ProtocolMessageMessage {
...
let SendCommandResultMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_sendCommandResultMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<SendCommandResultMessage>, ProtocolMessageMessage>(
...
extension SendError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SendError.Enum: SwiftProtobuf._ProtoNameProviding {
...
extension HandlerReturnStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension HandlerReturnStatus.Enum: SwiftProtobuf._ProtoNameProviding {
...
extension SendCommandStatusCode: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SendCommandStatusCode.Enum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0Success\0\u{1}NoSuchContent\0\u{1}CommandFailed\0\u{1}UIKitLegacy\0\u{2}\u{7}NoActionableNowPlayingItem\0\u{2}\u{a}DeviceNotFound\0\u{2}P\u{1}SkipAdProhibited\0\u{1}QueueIsUserCurated\0\u{1}UserModifiedQueueDisabled\0\u{1}UserQueueModificationNotSupportedForCurrentItem\0\u{1}SubscriptionRequiredForSharedQueue\0\u{1}InsertionPositionNotSpecified\0\u{1}InvalidInsertionPosition\0\u{1}RequestParametersOutOfBounds\0\u{1}SkipLimitReached\0\u{2}e\u{4}AuthenticationFailure\0\u{2}d\u{1}MediaServiceUnavailable\0")
}

extension SendCommandResultType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SendCommandResultType.Enum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}Dialog\0\u{1}Error\0\u{2}e\u{f}Custom\0")
}

extension SendCommandResultStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SendCommandResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SendCommandResultMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
