...
struct TextInputMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let TextInputMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_textInputMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<TextInputMessage>, ProtocolMessageMessage>(
...
extension ActionType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension ActionType.Enum: SwiftProtobuf._ProtoNameProviding {
...
extension TextInputMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
