...
struct SetConnectionStateMessage: Sendable {
...
let SetConnectionStateMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_setConnectionStateMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<SetConnectionStateMessage>, ProtocolMessageMessage>(
...
extension SetConnectionStateMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension SetConnectionStateMessage.ConnectionState: SwiftProtobuf._ProtoNameProviding {
