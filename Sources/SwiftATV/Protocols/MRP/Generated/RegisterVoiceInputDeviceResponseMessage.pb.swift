...
struct RegisterVoiceInputDeviceResponseMessage: Sendable {
...
let RegisterVoiceInputDeviceResponseMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_registerVoiceInputDeviceResponseMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<RegisterVoiceInputDeviceResponseMessage>, ProtocolMessageMessage>(
...
extension RegisterVoiceInputDeviceResponseMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
