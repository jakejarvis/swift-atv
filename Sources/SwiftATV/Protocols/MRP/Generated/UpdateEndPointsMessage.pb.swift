...
struct AVEndpointDescriptor: Sendable {
...
struct UpdateEndPointsMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let UpdateEndPointsMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_updateEndPointsMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<UpdateEndPointsMessage>, ProtocolMessageMessage>(
...
extension AVEndpointDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension UpdateEndPointsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
