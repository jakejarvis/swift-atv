...
struct VolumeControlAvailabilityMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
let VolumeControlAvailabilityMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_volumeControlAvailabilityMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<VolumeControlAvailabilityMessage>, ProtocolMessageMessage>(
...
extension VolumeCapabilities: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension VolumeCapabilities.Enum: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0None\0\u{1}Relative\0\u{1}Absolute\0\u{1}Both\0")
}

extension VolumeControlAvailabilityMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
