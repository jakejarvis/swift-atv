...
struct UpdateClientMessage: Sendable {
...
let UpdateClientMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_updateClientMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<UpdateClientMessage>, ProtocolMessageMessage>(
...
extension UpdateClientMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
