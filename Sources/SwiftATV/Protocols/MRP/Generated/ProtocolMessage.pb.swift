...
struct ProtocolMessageMessage: SwiftProtobuf.ExtensibleMessage, Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension ErrorCode.Enum: SwiftProtobuf._ProtoNameProviding {
...
extension ProtocolMessageMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension ProtocolMessageMessage.TypeEnum: SwiftProtobuf._ProtoNameProviding {
