...
struct RegisterForGameControllerEventsMessage: Sendable {
  ...
  enum InputModeFlags: Int, SwiftProtobuf.Enum, Swift.CaseIterable {
    case none = 0
    case motion = 1
    case buttons = 2
    case digitizer = 3
...
let RegisterForGameControllerEventsMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_registerForGameControllerEventsMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<RegisterForGameControllerEventsMessage>, ProtocolMessageMessage>(
...
extension RegisterForGameControllerEventsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
...
extension RegisterForGameControllerEventsMessage.InputModeFlags: SwiftProtobuf._ProtoNameProviding {
