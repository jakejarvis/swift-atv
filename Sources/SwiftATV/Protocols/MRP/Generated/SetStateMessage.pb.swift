...
struct SetStateMessage: @unchecked Sendable {
...
let SetStateMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
let Extensions_setStateMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<SetStateMessage>, ProtocolMessageMessage>(
...
extension SetStateMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
